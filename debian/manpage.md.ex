...
test - program to do something

# SYNOPSIS

**test** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
...
:   The system-wide configuration file to control the behaviour of
    test. See **foo.conf**(5) for further details.
...
**test** provides some return codes, that can be used in scripts:
